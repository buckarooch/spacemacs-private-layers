;;; packages.el --- hideout-org layer packages file for Spacemacs.
;;
...
;; added to `hideout-org-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `hideout-org/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `hideout-org/pre-init-PACKAGE' and/or
;;   `hideout-org/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst hideout-org-packages
  '()
  "The list of Lisp packages required by the hideout-org layer.
...
so change the default 'F' binding in the agenda to allow both"
  ...
  (setq org-agenda-diary-file "~/xvar/xorg/gtd/diary.org")
...
(defun hideout-org/pre-init-org ()
  (spacemacs|use-package-add-hook org
    :post-config
    (progn
      (setq org-default-notes-file "~/xvar/xorg/gtd/refile.org")
...
(defun hideout-org/post-init-org ()
  ...
  (setq org-directory "~/xvar/xorg/gtd")

  ;; Capture templates for: TODO tasks, Notes, appointments, phone calls,
  ;; meetings, and org-protocol
  (setq org-capture-templates
        (quote (("t" "todo" entry (file "~/xvar/xorg/gtd/refile.org")
                 "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
                ("r" "respond" entry (file "~/xvar/xorg/gtd/refile.org")
                 "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
                ("n" "note" entry (file "~/xvar/xorg/gtd/refile.org")
                 "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
                ("j" "Journal" entry (file+datetree "~/xvar/xorg/gtd/diary.org")
                 "* %?\n%U\n" :clock-in t :clock-resume t)
                ("w" "org-protocol" entry (file "~/xvar/xorg/gtd/refile.org")
                 "* TODO Review %c\n%U\n" :immediate-finish t)
                ("m" "Meeting" entry (file "~/xvar/xorg/gtd/refile.org")
                 "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
                ("p" "Phone call" entry (file "~/xvar/xorg/gtd/refile.org")
                 "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
                ("h" "Habit" entry (file "~/xvar/xorg/gtd/refile.org")
...
Skip project and sub-project tasks, habits, and loose non-project tasks."
  ...
  (setq org-ditaa-jar-path "~/xvar/xorg/org-mode/contrib/scripts/ditaa.jar")
  ...
  ;;               ("org-mode-doc-org"
  ;;                :base-directory "~/xvar/xorg/org-mode-doc/"
  ;;                :publishing-directory "/ssh:www-data@www:~/doc.norang.ca/htdocs"
  ;;                :recursive t
  ;;                :section-numbers nil
  ;;                :table-of-contents nil
